...
for voxel = 1:roi.n
   ...
   roi.voxM.linearCoords(voxel) = whichVoxel;
   roi.voxM.params(:,voxel) = params;
   roi.voxM.r2(voxel) = thisR2;
   roi.voxM.polarAngle(voxel) = thisPolarAngle;
   roi.voxM.eccentricity(voxel) = thisEccentricity;
   roi.voxM.rfHalfWidth(voxel) = thisRfHalfWidth;
   roi.voxM.tSeries(:,voxel) = m.tSeries;
   roi.voxM.pRFtSeries(:,voxel) = m.modelResponse;
   roi.voxM.baselineNoise = roi.voxAv.tSeries-roi.voxAv.pRFtSeries;
   roi.voxM.measurementVar(voxel) = var(m.tSeries-m.modelResponse);
...
v1.voxM.tSeries = v1.voxM.tSeries/100+1;
v1.voxM.pRFtSeries = v1.voxM.pRFtSeries/100+1;
v1.voxM.baselineNoise = v1.voxM.tSeries-v1.voxM.pRFtSeries;
v1.voxM.measurementVar = var(v1.voxM.baselineNoise);
